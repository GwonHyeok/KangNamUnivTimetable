...
public class TextViewOutline extends TextView {
    ...
    public void init(AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            if(a.hasValue(R.styleable.MagicTextView_mg_background)){
                Drawable background = a.getDrawable(R.styleable.MagicTextView_mg_background);
                if(background != null){
                    ...
                    this.setBackgroundColor(a.getColor(R.styleable.MagicTextView_mg_background, 0xff000000));
                }
            }
