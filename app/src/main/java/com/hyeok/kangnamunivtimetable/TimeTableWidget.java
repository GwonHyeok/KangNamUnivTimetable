...
public class TimeTableWidget extends AppWidgetProvider {
	...
	static private PendingIntent pendingIntent_12;
	@Override
	...
	public void onDisabled(Context context) {
	 ...
	 private static StringBuilder SetWidgetText(Context context) {
	...
	static void updateAppWidget(Context context,
		...
		String widgetText;//NewAppWidgetConfigureActivity.loadTitlePref(
				//context, appWidgetId);
